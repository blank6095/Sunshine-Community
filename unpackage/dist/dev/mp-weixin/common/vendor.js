...
function initRuntimeSocketService() {
  const hosts = "26.22.251.159,192.168.1.3,192.168.19.1,192.168.37.1,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_boZxJJ";
...
function rpx2px(value2) {
  return index$1.rpx2px(value2);
}
...
function t(value2, params2 = {}) {
  if (value2) {
    let lang = settings.lang;
    if (!settings.locales[settings.lang]) {
      lang = "zh-Hans";
    }
    let result = settings.locales[lang][value2] || value2;
...
function setConfig(configs) {
  ...
  index.shallowMerge(props$j, configs.props || {});
...
const props$i = defineMixin({
  props: {
    ...
    text: {
      type: [Array, String],
      default: () => props$j.noticeBar.text
    },
    // 通告滚动模式，row-横向滚动，column-竖向滚动
    direction: {
      type: String,
      default: () => props$j.noticeBar.direction
    },
    // direction = row时，是否使用步进形式滚动
    step: {
      type: Boolean,
      default: () => props$j.noticeBar.step
    },
    // 是否显示左侧的音量图标
    icon: {
      type: String,
      default: () => props$j.noticeBar.icon
    },
    // 通告模式，link-显示右箭头，closable-显示右侧关闭图标
    mode: {
      type: String,
      default: () => props$j.noticeBar.mode
    },
    // 文字颜色，各图标也会使用文字颜色
    color: {
      type: String,
      default: () => props$j.noticeBar.color
    },
    // 背景颜色
    bgColor: {
      type: String,
      default: () => props$j.noticeBar.bgColor
    },
    // 水平滚动时的滚动速度，即每秒滚动多少px(px)，这有利于控制文字无论多少时，都能有一个恒定的速度
    speed: {
      type: [String, Number],
      default: () => props$j.noticeBar.speed
    },
    // 字体大小
    fontSize: {
      type: [String, Number],
      default: () => props$j.noticeBar.fontSize
    },
    // 滚动一个周期的时间长，单位ms
    duration: {
      type: [String, Number],
      default: () => props$j.noticeBar.duration
    },
    // 是否禁止用手滑动切换
    // 目前HX2.6.11，只支持App 2.5.5+、H5 2.5.5+、支付宝小程序、字节跳动小程序
    disableTouch: {
      type: Boolean,
      default: () => props$j.noticeBar.disableTouch
    },
    // 跳转的页面路径
    url: {
      type: String,
      default: () => props$j.noticeBar.url
    },
    // 页面跳转的类型
    linkType: {
      type: String,
      default: () => props$j.noticeBar.linkType
    },
    justifyContent: {
      type: String,
      default: () => props$j.noticeBar.justifyContent
    }
  }
});
const props$h = defineMixin({
  props: {
    ...
    src: {
      type: String,
      default: () => props$j.avatar.src
    },
    // 头像形状，circle-圆形，square-方形
    shape: {
      type: String,
      default: () => props$j.avatar.shape
    },
    // 头像尺寸
    size: {
      type: [String, Number],
      default: () => props$j.avatar.size
    },
    // 裁剪模式
    mode: {
      type: String,
      default: () => props$j.avatar.mode
    },
    // 显示的文字
    text: {
      type: String,
      default: () => props$j.avatar.text
    },
    // 背景色
    bgColor: {
      type: String,
      default: () => props$j.avatar.bgColor
    },
    // 文字颜色
    color: {
      type: String,
      default: () => props$j.avatar.color
    },
    // 文字大小
    fontSize: {
      type: [String, Number],
      default: () => props$j.avatar.fontSize
    },
    // 显示的图标
    icon: {
      type: String,
      default: () => props$j.avatar.icon
    },
    // 显示小程序头像，只对百度，微信，QQ小程序有效
    mpAvatar: {
      type: Boolean,
      default: () => props$j.avatar.mpAvatar
    },
    // 是否使用随机背景色
    randomBgColor: {
      type: Boolean,
      default: () => props$j.avatar.randomBgColor
    },
    // 加载失败的默认头像(组件有内置默认图片)
    defaultUrl: {
      type: String,
      default: () => props$j.avatar.defaultUrl
    },
    ...
    colorIndex: {
      ...
      default: () => props$j.avatar.colorIndex
    },
    // 组件标识符
    name: {
      type: String,
      default: () => props$j.avatar.name
    }
  }
});
...
const props$d = defineMixin({
  props: {
    ...
    label: {
      type: String,
      default: () => props$j.formItem.label
    },
    // 绑定的值
    prop: {
      type: String,
      default: () => props$j.formItem.prop
    },
    // 绑定的规则
    rules: {
      type: Array,
      default: () => props$j.formItem.rules
    },
    // 是否显示表单域的下划线边框
    borderBottom: {
      type: [String, Boolean],
      default: () => props$j.formItem.borderBottom
    },
    // label的位置，left-左边，top-上边
    labelPosition: {
      type: String,
      default: () => props$j.formItem.labelPosition
    },
    // label的宽度，单位px
    labelWidth: {
      type: [String, Number],
      default: () => props$j.formItem.labelWidth
    },
    // 右侧图标
    rightIcon: {
      type: String,
      default: () => props$j.formItem.rightIcon
    },
    // 左侧图标
    leftIcon: {
      type: String,
      default: () => props$j.formItem.leftIcon
    },
    // 是否显示左边的必填星号，只作显示用，具体校验必填的逻辑，请在rules中配置
    required: {
      type: Boolean,
      default: () => props$j.formItem.required
    },
    leftIconStyle: {
      type: [String, Object],
      default: () => props$j.formItem.leftIconStyle
    }
  }
});
const props$c = defineMixin({
  props: {
    ...
    model: {
      type: Object,
      default: () => props$j.form.model
    },
    // 验证规则
    rules: {
      type: [Object, Function, Array],
      default: () => props$j.form.rules
    },
    // 有错误时的提示方式，message-提示信息，toast-进行toast提示
    // border-bottom-下边框呈现红色，none-无提示
    errorType: {
      type: String,
      default: () => props$j.form.errorType
    },
    // 是否显示表单域的下划线边框
    borderBottom: {
      type: Boolean,
      default: () => props$j.form.borderBottom
    },
    // label的位置，left-左边，top-上边
    labelPosition: {
      type: String,
      default: () => props$j.form.labelPosition
    },
    // label的宽度，单位px
    labelWidth: {
      type: [String, Number],
      default: () => props$j.form.labelWidth
    },
    // lable字体的对齐方式
    labelAlign: {
      type: String,
      default: () => props$j.form.labelAlign
    },
    // lable的样式，对象形式
    labelStyle: {
      type: Object,
      default: () => props$j.form.labelStyle
    }
  }
});
...
const props$a = defineMixin({
  props: {
    ...
    name: {
      ...
      default: () => props$j.checkbox.name
    },
    // 形状，square为方形，circle为圆型
    shape: {
      type: String,
      default: () => props$j.checkbox.shape
    },
    // 整体的大小
    size: {
      type: [String, Number],
      default: () => props$j.checkbox.size
    },
    // 是否默认选中
    checked: {
      type: Boolean,
      default: () => props$j.checkbox.checked
    },
    // 是否禁用
    disabled: {
      type: [String, Boolean],
      default: () => props$j.checkbox.disabled
    },
    // 选中状态下的颜色，如设置此值，将会覆盖parent的activeColor值
    activeColor: {
      type: String,
      default: () => props$j.checkbox.activeColor
    },
    // 未选中的颜色
    inactiveColor: {
      type: String,
      default: () => props$j.checkbox.inactiveColor
    },
    // 图标的大小，单位px
    iconSize: {
      type: [String, Number],
      default: () => props$j.checkbox.iconSize
    },
    // 图标颜色
    iconColor: {
      type: String,
      default: () => props$j.checkbox.iconColor
    },
    // label提示文字，因为nvue下，直接slot进来的文字，由于特殊的结构，无法修改样式
    label: {
      type: [String, Number],
      default: () => props$j.checkbox.label
    },
    // label的字体大小，px单位
    labelSize: {
      type: [String, Number],
      default: () => props$j.checkbox.labelSize
    },
    // label的颜色
    labelColor: {
      type: String,
      default: () => props$j.checkbox.labelColor
    },
    // 是否禁止点击提示语选中复选框
    labelDisabled: {
      type: [String, Boolean],
      default: () => props$j.checkbox.labelDisabled
    },
    // 是否独立使用
    usedAlone: {
      type: [Boolean],
...
const props$9 = defineMixin({
  props: {
    ...
    text: {
      type: [Array],
      default: () => props$j.columnNotice.text
    },
    // 是否显示左侧的音量图标
    icon: {
      type: String,
      default: () => props$j.columnNotice.icon
    },
    // 通告模式，link-显示右箭头，closable-显示右侧关闭图标
    mode: {
      type: String,
      default: () => props$j.columnNotice.mode
    },
    // 文字颜色，各图标也会使用文字颜色
    color: {
      type: String,
      default: () => props$j.columnNotice.color
    },
    // 背景颜色
    bgColor: {
      type: String,
      default: () => props$j.columnNotice.bgColor
    },
    // 字体大小，单位px
    fontSize: {
      type: [String, Number],
      default: () => props$j.columnNotice.fontSize
    },
    // 水平滚动时的滚动速度，即每秒滚动多少px(px)，这有利于控制文字无论多少时，都能有一个恒定的速度
    speed: {
      type: [String, Number],
      default: () => props$j.columnNotice.speed
    },
    // direction = row时，是否使用步进形式滚动
    step: {
      type: Boolean,
      default: () => props$j.columnNotice.step
    },
    // 滚动一个周期的时间长，单位ms
    duration: {
      type: [String, Number],
      default: () => props$j.columnNotice.duration
    },
    // 是否禁止用手滑动切换
    // 目前HX2.6.11，只支持App 2.5.5+、H5 2.5.5+、支付宝小程序、字节跳动小程序
    disableTouch: {
      type: Boolean,
      default: () => props$j.columnNotice.disableTouch
    },
    justifyContent: {
      type: String,
      default: () => props$j.columnNotice.justifyContent
    }
  }
});
const props$8 = defineMixin({
  props: {
    ...
    text: {
      type: String,
      default: () => props$j.rowNotice.text
    },
    // 是否显示左侧的音量图标
    icon: {
      type: String,
      default: () => props$j.rowNotice.icon
    },
    // 通告模式，link-显示右箭头，closable-显示右侧关闭图标
    mode: {
      type: String,
      default: () => props$j.rowNotice.mode
    },
    // 文字颜色，各图标也会使用文字颜色
    color: {
      type: String,
      default: () => props$j.rowNotice.color
    },
    // 背景颜色
    bgColor: {
      type: String,
      default: () => props$j.rowNotice.bgColor
    },
    // 字体大小，单位px
    fontSize: {
      type: [String, Number],
      default: () => props$j.rowNotice.fontSize
    },
    // 水平滚动时的滚动速度，即每秒滚动多少px(rpx)，这有利于控制文字无论多少时，都能有一个恒定的速度
    speed: {
      type: [String, Number],
      default: () => props$j.rowNotice.speed
    }
  }
});
const icons = {
...
const props$6 = defineMixin({
  props: {
    ...
    type: {
      type: String,
      default: () => props$j.text.type
    },
    // 是否显示
    show: {
      type: Boolean,
      default: () => props$j.text.show
    },
    // 显示的值
    text: {
      type: [String, Number],
      default: () => props$j.text.text
    },
    // 前置图标
    prefixIcon: {
      type: String,
      default: () => props$j.text.prefixIcon
    },
    // 后置图标
    suffixIcon: {
      type: String,
      default: () => props$j.text.suffixIcon
    },
    // 文本处理的匹配模式
    // text-普通文本，price-价格，phone-手机号，name-姓名，date-日期，link-超链接
    mode: {
      type: String,
      default: () => props$j.text.mode
    },
    // mode=link下，配置的链接
    href: {
      type: String,
      default: () => props$j.text.href
    },
    // 格式化规则
    format: {
      type: [String, Function],
      default: () => props$j.text.format
    },
    // mode=phone时，点击文本是否拨打电话
    call: {
      type: Boolean,
      default: () => props$j.text.call
    },
    // 小程序的打开方式
    openType: {
      type: String,
      default: () => props$j.text.openType
    },
    // 是否粗体，默认normal
    bold: {
      type: Boolean,
      default: () => props$j.text.bold
    },
    // 是否块状
    block: {
      type: Boolean,
      default: () => props$j.text.block
    },
    // 文本显示的行数，如果设置，超出此行数，将会显示省略号
    lines: {
      type: [String, Number],
      default: () => props$j.text.lines
    },
    // 文本颜色
    color: {
      type: String,
      default: () => props$j.text.color
    },
    // 字体大小
    size: {
      type: [String, Number],
      default: () => props$j.text.size
    },
    // 图标的样式
    iconStyle: {
      type: [Object, String],
      default: () => props$j.text.iconStyle
    },
    // 文字装饰，下划线，中划线等，可选值 none|underline|line-through
    decoration: {
      tepe: String,
      default: () => props$j.text.decoration
    },
    // 外边距，对象、字符串，数值形式均可
    margin: {
      type: [Object, String, Number],
      default: () => props$j.text.margin
    },
    // 文本行高
    lineHeight: {
      type: [String, Number],
      default: () => props$j.text.lineHeight
    },
    // 文本对齐方式，可选值left|center|right
    align: {
      type: String,
      default: () => props$j.text.align
    },
    // 文字换行，可选值break-word|normal|anywhere
    wordWrap: {
      type: String,
      default: () => props$j.text.wordWrap
    },
    // 占满剩余空间
    flex1: {
      type: Boolean,
      default: () => props$j.text.flex1
    }
  }
});
const value = {
...
const props$1 = defineMixin({
  props: {
    ...
    color: {
      type: String,
      default: () => props$j.link.color
    },
    // 字体大小，单位px
    fontSize: {
      type: [String, Number],
      default: () => props$j.link.fontSize
    },
    // 是否显示下划线
    underLine: {
      type: Boolean,
      default: () => props$j.link.underLine
    },
    // 要跳转的链接
    href: {
      type: String,
      default: () => props$j.link.href
    },
    // 小程序中复制到粘贴板的提示语
    mpTips: {
      type: String,
      default: () => props$j.link.mpTips
    },
    // 下划线颜色
    lineColor: {
      type: String,
      default: () => props$j.link.lineColor
    },
    // 超链接的问题，不使用slot形式传入，是因为nvue下无法修改颜色
    text: {
      type: String,
      default: () => props$j.link.text
    }
  }
});
